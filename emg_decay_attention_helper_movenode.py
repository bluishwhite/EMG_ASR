...
from src.data.dataset import MoveNodeEMGDataset, TextLineDataset, ZipDataset
...
class EMGASRDecayHelper(object):
    def __init__(self, model, tgt_vocab, configs, use_cuda):
        ...
        train_bitext_dataset = ZipDataset(
            MoveNodeEMGDataset(data_path=data_configs['train_data'][0],nfft=data_configs['nfft'],
