...
from src.emg_ctc_voice_npy_helper import *
...
def train(nmt, configs, args,beam_decoder):
    ...
    for iter in range(502):
        ...
        for batch in training_iter:
            ...
            if global_step % training_configs['loss_valid_freq'] == 0:
                ...
                dev_cer = evaluate(nmt, training_configs, data_configs,beam_decoder)
...
if __name__ == '__main__':
    ...
    nmt = EMGAddVoiceNPYCTCHelper(nmt_model, tgt_vocab, configs, use_cuda)
