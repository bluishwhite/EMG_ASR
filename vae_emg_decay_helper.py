...
class VaeEMGASRDecayHelper(object):
    ...
    def compute_forward(self, seqs_x, seqs_y,ctc_y, ctc_lengths, norm, iter, step):
        ...
        self.critic.train()
        # For training
        # att_weight = 1- kl_anneal_function(iter)
    ...
    def train_batch(self, seqs_x_t, seqs_y_t, norm,iter,step):
        ...
        stat = self.compute_forward(src_words, tgt_words,ctc_targets,tgt_lengths, norm,iter,step)
