...
class VaeEMGMIXASRDecayHelper(object):
    ...
    def pair_data_variable(self, features, seqs_y_t):
        ...
        return padded_features, tgt_words
    ...
    def compute_forward(self, seqs_x, seqs_y, norm,iter):
        inputs, targets_a, targets_b, ctc_ya, ctc_yb, ctc_ya_length, ctc_yb_length, lam = self.mixup_data(seqs_x, seqs_y,self.mix_alpha, use_cuda=True)
    ...
    def train_batch(self, seqs_x_t, seqs_y_t, norm,iter):
        ...
        src_words, tgt_words = self.pair_data_variable(feature, seqs_y)
        
        stat = self.compute_forward(src_words, tgt_words, norm,iter)
