...
from src.data.dataset import EMGDataset, TextLineDataset, ZipDataset,EMGAddVoiceDataset
...
class EMGVoiceMIXCTCHelper(object):
    def __init__(self, model, tgt_vocab, configs, use_cuda):
        ...
        train_bitext_dataset = ZipDataset(
            EMGAddVoiceDataset(data_path=data_configs['train_data'][0],nfft=data_configs['nfft'],
    ...
    def mixup_data(self,weis, x, y,alpha=1.0, use_cuda=True):
        ...
        return mixed_wights, mixed_x,ctc_ya, ctc_yb, ya_lengths, yb_lengths, lam
