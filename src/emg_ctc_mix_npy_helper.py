...
from src.data.dataset import EMGNPYDataset, TextLineDataset, ZipDataset,EMGDataset
...
class EMGMIXCTCHelper(object):
    ...
    def mixup_data(self, x, y,alpha=1.0, use_cuda=True):
        ...
        return mixed_x,ctc_ya, ctc_yb, ya_lengths, yb_lengths, lam
    ...
    def compute_forward(self, seqs_x, seqs_y,ctc_y, ctc_lengths, norm,step):
        ...
        inputs, ctc_ya, ctc_yb, ctc_ya_length, ctc_yb_length, lam = self.mixup_data(seqs_x, seqs_y,self.mix_alpha, use_cuda=True)
