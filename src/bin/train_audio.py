...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_path', type=str, default="configs/audio/transformer_audio.yaml",
                        help="The path to config file.")
    parser.add_argument('--saveto', type=str, default="./save/audio/transformer",
    ...
    nmt = NMTHelper(nmt_model, tgt_vocab, configs, use_cuda)
