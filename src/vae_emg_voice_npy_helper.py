...
class VaeEMGASRDecayHelper(object):
    ...
    def compute_forward(self, weights, seqs_x, seqs_y,ctc_y, ctc_lengths, norm, iter):
        ...
        with torch.enable_grad():
            ...
            loss = closs + self.att_weight*loss_kl_anneal_function(iter) * KLD
    ...
    def train_batch(self, seqs_x_t, seqs_y_t, norm,iter):
        self.model.train()
        ...
        stat = self.compute_forward(weights, src_words, tgt_words,ctc_targets,tgt_lengths, norm,iter)
