...
from src.vae_emg_decay_mix_npy_helper import *
...
def train(nmt, configs, args,ctc_decoder):
        ...
        for batch in training_iter:
            ...
            try:
                ...
                for seqs_x_t, seqs_y_t in split_shard(seqs_x, seqs_y, split_size=training_configs['update_cycle']):
                    ...
                    stat = nmt.train_batch(seqs_x_t, seqs_y_t, n_samples_t,iter)
            ...
            if global_step % training_configs['loss_valid_freq'] == 0:
                ...
                dev_cer = evaluate(nmt, training_configs, data_configs,ctc_decoder)
...
def evaluate(nmt, training_configs, data_configs,ctcdecoder):
    ...
    for xs in valid_iter:
        ...
        sub_trans = nmt.ctc_beamsearch_batch(seqs_x,ctcdecoder, beam_size, max_steps, alpha)
...
def test(nmt, configs, args, ctcdecoder):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpu', default=5, type=int, help='Use id of gpu, -1 if cpu.')
    ...
    nmt = VaeEMGMIXASRDecayHelper(nmt_model, tgt_vocab, configs, use_cuda)
