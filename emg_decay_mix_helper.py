...
class EMGMIXASRDecayHelper(object):
    ...
    def compute_forward(self, seqs_x, seqs_y,seqs_tgt, norm,step):
        ...
        with torch.enable_grad():
            ...
            log_probs_a, encoder_log_pro_a, encoder_output_length_a= self.model(inputs, ya_inp)
            log_probs_b, encoder_log_pro_b, encoder_output_length_b= self.model(inputs, yb_inp)
